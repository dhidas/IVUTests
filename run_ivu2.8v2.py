...
if device != 'ISR' and device != 'SMI' and device != 'LIX':
    raise ValueError('first argument must be ISR SMI LIX')

pvid = 'SR:C04-ID:G1{IVU:1'
if device == 'SMI':
    pvid = 'SR:C12-ID:G1{IVU:1'
elif device == 'LIX':
    pvid = 'SR:C16-ID:G1{IVU:1'
